        ...
        <div className="pt-10">
            ...
            <div className="min-h-[500px] border-2 mb-12 rounded-lg lg:flex bg-base-300 md:p-10">
                <div className="lg:w-1/2 p-6">
                    ...
                    <button className="btn bg-[#D2B48C] mt-5 w-full">Send Email</button>
                </div>

                <div className="lg:w-1/2 p-6 space-y-10 md:mt-14">
                    <div className="border border-[#D2B48C] rounded-xl p-5 flex gap-6 items-center">
                    ...
                    <div className=" text-center">
                        <button className="btn bg-[#D2B48C] w-full">View On Map</button>
                    </div>
                </div>
            </div>
        </div>
